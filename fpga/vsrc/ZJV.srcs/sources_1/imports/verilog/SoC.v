module SoC (
    ...
    // UART Interrupt (the only interrupt signal to Plic in ZJV hart)
    wire        io_meip;
    ...
    Mem axi4_mem (
        ...
        .reset(reset),
        // AXI
        .m0_axi4_aw_ready(cpu_io_mem_awready),
        .m0_axi4_aw_valid(cpu_io_mem_awvalid),
        .m0_axi4_aw_id(cpu_io_mem_awid),
        .m0_axi4_aw_addr(cpu_io_mem_awaddr),
        .m0_axi4_aw_len(cpu_io_mem_awlen),
        .m0_axi4_aw_size(cpu_io_mem_awsize),
        .m0_axi4_aw_burst(cpu_io_mem_awburst),
        .m0_axi4_w_ready(cpu_io_mem_wready),
        .m0_axi4_w_valid(cpu_io_mem_wvalid),
        .m0_axi4_w_data(cpu_io_mem_wdata),
        .m0_axi4_w_strb(cpu_io_mem_wstrb),
        .m0_axi4_w_last(cpu_io_mem_wlast),
        .m0_axi4_b_ready(cpu_io_mem_bready),
        .m0_axi4_b_valid(cpu_io_mem_bvalid),
        .m0_axi4_b_id(cpu_io_mem_bid),
        .m0_axi4_b_resp(cpu_io_mem_bresp),
        .m0_axi4_ar_ready(cpu_io_mem_arready),
        .m0_axi4_ar_valid(cpu_io_mem_arvalid),
        .m0_axi4_ar_id(cpu_io_mem_arid),
        .m0_axi4_ar_addr(cpu_io_mem_araddr),
        .m0_axi4_ar_len(cpu_io_mem_arlen),
        .m0_axi4_ar_size(cpu_io_mem_arsize),
        .m0_axi4_ar_burst(cpu_io_mem_arburst),
        .m0_axi4_r_ready(cpu_io_mem_rready),
        .m0_axi4_r_valid(cpu_io_mem_rvalid),
        .m0_axi4_r_id(cpu_io_mem_rid),
        .m0_axi4_r_data(cpu_io_mem_rdata),
        .m0_axi4_r_resp(cpu_io_mem_rresp),
        .m0_axi4_r_last(cpu_io_mem_rlast),
        // DDR2
        .ddr_dq(ddr_dq),
        .ddr_dqs_n(ddr_dqs_n),
        .ddr_dqs_p(ddr_dqs_p),
    ...
    MemMappedIO axi4_mmio (
        ...
        .m0_axi4_r_valid(cpu_io_mmio_rvalid),
